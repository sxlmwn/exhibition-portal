    ...
    <div className="glass-card glass-card-hover p-6 rounded-3xl relative overflow-hidden flex flex-col justify-between">
      ...
      <div className="flex items-start justify-between gap-4 mb-4">
        <div>
          ...
          <h3 className="font-serif text-3xl sm:text-4xl font-bold text-charcoal tracking-tight">
            {value}
          </h3>
          {subvalue && (
      ...
      {trend && (
        <div className="pt-3 border-t border-sage-100 flex items-center gap-2 text-xs">
